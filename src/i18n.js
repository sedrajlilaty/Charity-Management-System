...
const ar = {
    translation: {
        ...
        beneficiaries: {
            ...
            modal: {
                addTitle: 'إضافة مستفيد جديد',
                editTitle: 'تعديل بيانات المستفيد',
                typeLabel: 'نوع المستفيد',
                saveBtn: 'إضافة المستفيد',
                ...
                fields: {
                    ...
                    sponsorshipTitle: 'عنوان الكفالة',
                    requestTitle: 'عنوان الطلب',

                    caseDescription: 'وصف الحالة',
                    needDescription: 'وصف الاحتياج',
                    caseDescPlaceholder: 'وصف الحالة الصحية والاحتياج...',
                    familyDescPlaceholder: 'وصف وضع الأسرة والاحتياجات...',
                    studentDescPlaceholder: 'وصف وضع الطالب وما يحتاجه...',
                    universityDescPlaceholder: 'وصف وضع الطالب والهدف من الدعم...',

                    requiredAmount: 'المبلغ المطلوب ($)',
                    academicGrade: 'المرحلة الدراسية',
                    academicGradePlaceholder: 'مثال: الصف التاسع',
                    schoolName: 'اسم المدرسة',
                    academicYear: 'السنة الدراسية',
                    academicYearPlaceholder: 'مثال: السنة الثالثة',
                    supportType: 'نوع الدعم',
                    supportTypeLaptop: 'دعم لابتوب 💻',
                    supportTypeTuition: 'دعم رسوم دراسية 🎓',

                    titlePlaceholder: {
                        patient: 'مثال: مريض سرطان يحتاج تمويل علاج',
                        orphan: 'مثال: كفالة يتيم — أسرة الرشيدي',
                        school_student: 'مثال: دعم طالب مدرسة — الصف التاسع',
                        university_student: 'مثال: دعم طالب جامعي — هندسة حاسوب',
                    },
                },
                ...
                files: {
                    ...
                    nationalIdDocument: 'وثيقة الهوية',
                    familyBooklet: 'دفتر العائلة',
                    fatherDeathCertificate: 'وثيقة وفاة الوالد',
                    familyBookPhoto: 'صورة دفتر العائلة',
                    universityIdPhoto: 'بطاقة الجامعة',
                    uploadPrompt: 'اضغط أو اسحب الملف',
                    uploadHintDoc: 'JPG, PNG, PDF — max 5MB',
                    uploadHintImg: 'JPG, PNG — max 5MB',
        ...
        volunteers: {
            title: 'المتطوعون',
            subtitle: '{{count}} متطوع',
            addBtn: 'إضافة متطوع',
            searchPlaceholder: 'البحث باسم المتطوع...',
            tabs: { all: 'الكل', pending: 'قيد الانتظار', approved: 'مقبول', completed: 'مكتمل', rejected: 'مرفوض' },
            table: { name: 'الاسم', campaign: 'الحملة', status: 'الحالة', actions: 'الإجراءات' },
            kanban: {
                title: 'لوحة كانبان',
                listView: 'عرض القائمة',
                boardView: 'عرض اللوحة',
                columns: { pending: 'قيد الانتظار', approved: 'مقبول', completed: 'مكتمل', rejected: 'مرفوض' },
            },
            empty: 'لا توجد بيانات',
            modal: {
                titleAdd: 'طلب تطوع جديد',
                titleEdit: 'تعديل طلب التطوع',
                titleDetails: 'تفاصيل طلب التطوع',
                name: 'اسم المتطوع',
                ...
                availability: 'التوفر',
                availabilityPlaceholder: 'اختر التوفر',
                experience: 'الخبرة',
                experiencePlaceholder: 'اختر مستوى الخبرة',
                notes: 'ملاحظات',
                notesPlaceholder: 'أي معلومات إضافية...',
                skills: { medical: 'طبي / صحي', teaching: 'تعليم', logistics: 'لوجستي', social: 'اجتماعي', technical: 'تقني', other: 'أخرى' },
                availability_options: { morning: 'صباحي', evening: 'مسائي', weekend: 'عطلة نهاية الأسبوع', flexible: 'مرن' },
                experience_options: { none: 'بدون خبرة', '1_2': '1 - 2 سنة', '3_5': '3 - 5 سنوات', '5_plus': 'أكثر من 5 سنوات' },
                PermissionButtons: { cancel: 'إلغاء', create: 'إنشاء الطلب', update: 'حفظ التغييرات', approve: 'قبول الطلب', reject: 'رفض الطلب' },
                confirm: {
                    approveTitle: 'تأكيد قبول الطلب',
                    rejectTitle: 'تأكيد رفض الطلب',
                    approveMessage: 'هل أنت متأكد من رغبتك في قبول طلب التطوع الخاص بـ {{name}}؟',
                    rejectMessage: 'هل أنت متأكد من رغبتك في رفض طلب التطوع الخاص بـ {{name}}؟',
                ...
                errors: {
                    ...
                    availabilityRequired: 'يرجى اختيار التوفر',
                },
            },
        },
...
const en = {
    translation: {
        ...
        beneficiaries: {
            ...
            modal: {
                addTitle: 'Add New Beneficiary',
                editTitle: 'Edit Beneficiary Info',
                typeLabel: 'Beneficiary Type',
                saveBtn: 'Add Beneficiary',
                ...
                fields: {
                    ...
                    caseDescPlaceholder: 'Describe the medical condition and need...',
                    familyDescPlaceholder: "Describe the family's situation and needs...",
                    studentDescPlaceholder: 'Describe the student situation and needs...',
                    universityDescPlaceholder: "Describe the student's situation and support goal...",

                    requiredAmount: 'Required Amount ($)',
                    academicGrade: 'Academic Grade',
                    academicGradePlaceholder: 'e.g. 9th Grade',
                    schoolName: 'School Name',
                    academicYear: 'Academic Year',
                    academicYearPlaceholder: 'e.g. Third Year',
                    supportType: 'Support Type',
                    supportTypeLaptop: 'Laptop Support 💻',
                    supportTypeTuition: 'Tuition Assistance 🎓',

                    titlePlaceholder: {
                        patient: 'e.g. Cancer patient needing treatment funding',
                        orphan: 'e.g. Orphan sponsorship — Al-Rashidi family',
                        school_student: 'e.g. School student support — 9th grade',
                        university_student: 'e.g. University student — computer engineering',
                    },
                },
                ...
                files: {
                    ...
                    medicalReport: 'Medical Report',
                    nationalIdDocument: 'ID Document',
                    familyBooklet: 'Family Booklet',
                    fatherDeathCertificate: "Father's Death Certificate",
                    familyBookPhoto: 'Family Book Photo',
                    universityIdPhoto: 'University ID Card',
        ...
        volunteers: {
            title: 'Volunteers',
            subtitle: '{{count}} volunteers',
            addBtn: 'Add Volunteer',
            ...
            empty: 'No data',
            modal: {
                titleAdd: 'New Volunteer Request',
                titleEdit: 'Edit Volunteer Request',
                titleDetails: 'Volunteer Request Details',
                name: 'Volunteer name',
                ...
                PermissionButtons: { cancel: 'Cancel', create: 'Create request', update: 'Save changes', approve: 'Approve Application', reject: 'Reject Application' },
                confirm: {
                    approveTitle: 'Confirm Application Approval',
                    rejectTitle: 'Confirm Application Rejection',
                    approveMessage: 'Are you sure you want to approve the volunteer application for {{name}}?',
                    rejectMessage: 'Are you sure you want to reject the volunteer application for {{name}}?',
